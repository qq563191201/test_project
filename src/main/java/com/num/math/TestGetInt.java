...
public class TestGetInt {
	public static void main(String[] args){
		   ...
		   */
		   ...
		   long time = 1472800205463L;     
		   BigDecimal v1 = new BigDecimal(Double.valueOf(now));
		   BigDecimal v2 = new BigDecimal(Double.valueOf(time));
		   BigDecimal v3 = new BigDecimal(Double.valueOf(1000D));
		   int dd = v1.subtract(v2).divide(v3, 0 , BigDecimal.ROUND_HALF_UP).intValue();
		   System.out.println("四舍五入取整:(2)=" + new BigDecimal("2").setScale(0, BigDecimal.ROUND_HALF_UP));
		   System.out.println("四舍五入取整:(2.1)=" + new BigDecimal("2.1").setScale(0, BigDecimal.ROUND_HALF_UP));
		   double ss = (now-time)/1000;
		   System.out.println(dd+"四舍五入取整:(2.5)="+(now-time)+"/" + new BigDecimal(dd).setScale(0, BigDecimal.ROUND_HALF_UP));
